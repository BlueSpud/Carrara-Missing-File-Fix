...
static const char qt_meta_stringdata_QAbstractTextDocumentLayout[] = {
    "QAbstractTextDocumentLayout\0update(QRectF)\0"
    "\0update()\0updateBlock(QTextBlock)\0"
    "block\0documentSizeChanged(QSizeF)\0"
    "newSize\0pageCountChanged(int)\0newPages\0"
    "_q_handlerDestroyed(QObject*)\0obj\0"
    "_q_dynamicPageCountSlot()\0int\0"
    "_q_dynamicDocumentSizeSlot()\0QSizeF\0"
};

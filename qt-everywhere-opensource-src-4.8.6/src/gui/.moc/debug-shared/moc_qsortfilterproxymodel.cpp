...
static const char qt_meta_stringdata_QSortFilterProxyModel[] = {
    "QSortFilterProxyModel\0setFilterRegExp(QString)\0"
    "pattern\0\0setFilterWildcard(QString)\0"
    "setFilterFixedString(QString)\0clear()\0"
    "invalidate()\0_q_sourceDataChanged(QModelIndex,QModelIndex)\0"
    "source_top_left,source_bottom_right\0"
    "_q_sourceHeaderDataChanged(Qt::Orientation,int,int)\0"
    "orientation,start,end\0_q_sourceAboutToBeReset()\0"
    ...
    "_q_clearMapping()\0filterRegExp\0QRegExp\0"
    "filterKeyColumn\0int\0dynamicSortFilter\0"
    "bool\0filterCaseSensitivity\0"

...
static const char qt_meta_stringdata_QAbstractSlider[] = {
    "QAbstractSlider\0valueChanged(int)\0"
    "value\0\0sliderPressed()\0sliderMoved(int)\0"
    "position\0sliderReleased()\0"
    "rangeChanged(int,int)\0min,max\0"
    "actionTriggered(int)\0action\0setValue(int)\0"
    "setOrientation(Qt::Orientation)\0minimum\0"
    "int\0maximum\0singleStep\0pageStep\0"
    "sliderPosition\0tracking\0bool\0orientation\0"
    "Qt::Orientation\0invertedAppearance\0"
    "invertedControls\0sliderDown\0"
};

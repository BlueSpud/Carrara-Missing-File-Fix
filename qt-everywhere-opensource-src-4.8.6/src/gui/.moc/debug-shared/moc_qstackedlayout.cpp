...
static const char qt_meta_stringdata_QStackedLayout[] = {
    "QStackedLayout\0widgetRemoved(int)\0"
    "index\0\0currentChanged(int)\0"
    "setCurrentIndex(int)\0setCurrentWidget(QWidget*)\0"
    "w\0currentIndex\0int\0stackingMode\0"
    "StackingMode\0StackOne\0StackAll\0"
};

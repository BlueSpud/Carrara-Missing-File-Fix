...
static const char qt_meta_stringdata_QComboBox[] = {
    "QComboBox\0editTextChanged(QString)\0\0"
    "activated(int)\0index\0activated(QString)\0"
    "highlighted(int)\0highlighted(QString)\0"
    "currentIndexChanged(int)\0"
    "currentIndexChanged(QString)\0clear()\0"
    "clearEditText()\0setEditText(QString)\0"
    "text\0setCurrentIndex(int)\0"
    "_q_itemSelected(QModelIndex)\0item\0"
    ...
    ",\0_q_updateIndexBeforeChange()\0"
    "_q_rowsInserted(QModelIndex,int,int)\0"
    "parent,start,end\0_q_rowsRemoved(QModelIndex,int,int)\0"
    "_q_modelDestroyed()\0_q_modelReset()\0"
    "editable\0bool\0count\0int\0currentText\0"
    "QString\0currentIndex\0maxVisibleItems\0"
    "maxCount\0insertPolicy\0InsertPolicy\0"
    "sizeAdjustPolicy\0SizeAdjustPolicy\0"
    "minimumContentsLength\0iconSize\0QSize\0"
    "autoCompletion\0autoCompletionCaseSensitivity\0"

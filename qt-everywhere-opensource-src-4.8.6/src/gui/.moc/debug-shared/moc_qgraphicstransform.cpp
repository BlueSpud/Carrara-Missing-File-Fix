...
static const char qt_meta_stringdata_QGraphicsTransform[] = {
    "QGraphicsTransform\0update()\0\0"
};
...
static const uint qt_meta_data_QGraphicsScale[] = {
 ...
 // properties: name, type, flags
      95,  102, 0x54495103,
     112,  119, ((uint)QMetaType::QReal << 24) | 0x00495103,
     125,  119, ((uint)QMetaType::QReal << 24) | 0x00495103,
     132,  119, ((uint)QMetaType::QReal << 24) | 0x00495103,
...
static const char qt_meta_stringdata_QGraphicsScale[] = {
    ...
    "zScaleChanged()\0scaleChanged()\0origin\0"
    "QVector3D\0xScale\0qreal\0yScale\0zScale\0"
};
...
static const uint qt_meta_data_QGraphicsRotation[] = {
 ...
 // properties: name, type, flags
      64,   71, 0x54495103,
      81,   87, ((uint)QMetaType::QReal << 24) | 0x00495103,
      93,   71, 0x54495103,
...
static const char qt_meta_stringdata_QGraphicsRotation[] = {
    ...
    "angleChanged()\0axisChanged()\0origin\0"
    "QVector3D\0angle\0qreal\0axis\0"
};

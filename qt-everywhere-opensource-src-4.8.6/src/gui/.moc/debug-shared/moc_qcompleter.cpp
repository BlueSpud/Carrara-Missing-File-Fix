...
static const char qt_meta_stringdata_QCompleter[] = {
    "QCompleter\0activated(QString)\0text\0\0"
    "activated(QModelIndex)\0index\0"
    "highlighted(QString)\0highlighted(QModelIndex)\0"
    "setCompletionPrefix(QString)\0prefix\0"
    "complete(QRect)\0rect\0complete()\0"
    "setWrapAround(bool)\0wrap\0"
    "_q_complete(QModelIndex)\0"
    "_q_completionSelected(QItemSelection)\0"
    "_q_autoResizePopup()\0"
    "_q_fileSystemModelDirectoryLoaded(QString)\0"
    "completionPrefix\0QString\0modelSorting\0"
    "ModelSorting\0completionMode\0CompletionMode\0"
    "completionColumn\0int\0completionRole\0"
    "maxVisibleItems\0caseSensitivity\0"
    "Qt::CaseSensitivity\0wrapAround\0bool\0"
};

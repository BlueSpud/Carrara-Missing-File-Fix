...
static const char qt_meta_stringdata_QToolBar[] = {
    "QToolBar\0actionTriggered(QAction*)\0"
    "action\0\0movableChanged(bool)\0movable\0"
    "allowedAreasChanged(Qt::ToolBarAreas)\0"
    "allowedAreas\0orientationChanged(Qt::Orientation)\0"
    "orientation\0iconSizeChanged(QSize)\0"
    "iconSize\0toolButtonStyleChanged(Qt::ToolButtonStyle)\0"
    "toolButtonStyle\0topLevelChanged(bool)\0"
    "topLevel\0visibilityChanged(bool)\0"
    "visible\0setIconSize(QSize)\0"

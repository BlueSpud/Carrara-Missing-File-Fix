...
static const char qt_meta_stringdata_QProxyModel[] = {
    "QProxyModel\0_q_sourceDataChanged(QModelIndex,QModelIndex)\0"
    ",\0\0_q_sourceRowsAboutToBeInserted(QModelIndex,int,int)\0"
    ",,\0_q_sourceRowsInserted(QModelIndex,int,int)\0"

...
static const char qt_meta_stringdata_QListWidget[] = {
    "QListWidget\0itemPressed(QListWidgetItem*)\0"
    "item\0\0itemClicked(QListWidgetItem*)\0"
    ...
    "current,previous\0currentTextChanged(QString)\0"
    "currentText\0currentRowChanged(int)\0"
    "currentRow\0itemSelectionChanged()\0"
    "scrollToItem(const QListWidgetItem*,QAbstractItemView::ScrollHint)\0"
    "item,hint\0scrollToItem(const QListWidgetItem*)\0"
    "clear()\0_q_emitItemPressed(QModelIndex)\0"
    "index\0_q_emitItemClicked(QModelIndex)\0"
    ...
    "topLeft,bottomRight\0count\0int\0"
    "sortingEnabled\0bool\0"
};

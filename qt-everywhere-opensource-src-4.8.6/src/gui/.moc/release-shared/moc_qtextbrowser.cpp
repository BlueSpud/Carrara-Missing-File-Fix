...
static const char qt_meta_stringdata_QTextBrowser[] = {
    "QTextBrowser\0backwardAvailable(bool)\0"
    "\0forwardAvailable(bool)\0historyChanged()\0"
    "sourceChanged(QUrl)\0highlighted(QUrl)\0"
    "highlighted(QString)\0anchorClicked(QUrl)\0"
    "setSource(QUrl)\0name\0backward()\0"
    "forward()\0home()\0reload()\0"
    "_q_documentModified()\0_q_activateAnchor(QString)\0"
    "_q_highlightLink(QString)\0source\0QUrl\0"
    "searchPaths\0QStringList\0openExternalLinks\0"
    "bool\0openLinks\0"
};

...
static const uint qt_meta_data_QTextDocument[] = {
 ...
 // properties: name, type, flags
     ...
     425,  377, 0x01095103,
     442,  400, 0x16095001,
     447,  457, ((uint)QMetaType::QReal << 24) | 0x00095103,
     463,  474, 0x02095001,
     478,  457, ((uint)QMetaType::QReal << 24) | 0x00095103,
     490,  508, 0x0a095103,
     516,  474, 0x02095103,
     534,  457, ((uint)QMetaType::QReal << 24) | 0x00095103,

       0        // eod
};

static const char qt_meta_stringdata_QTextDocument[] = {
    "QTextDocument\0contentsChange(int,int,int)\0"
    "from,charsRemoves,charsAdded\0\0"
    "contentsChanged()\0undoAvailable(bool)\0"
    "redoAvailable(bool)\0undoCommandAdded()\0"
    "modificationChanged(bool)\0m\0"
    "cursorPositionChanged(QTextCursor)\0"
    "cursor\0blockCountChanged(int)\0"
    "newBlockCount\0documentLayoutChanged()\0"
    "undo()\0redo()\0appendUndoItem(QAbstractUndoItem*)\0"
    "setModified(bool)\0setModified()\0"
    "undoRedoEnabled\0bool\0modified\0pageSize\0"
    "QSizeF\0defaultFont\0QFont\0useDesignMetrics\0"
    "size\0textWidth\0qreal\0blockCount\0int\0"
    "indentWidth\0defaultStyleSheet\0QString\0"

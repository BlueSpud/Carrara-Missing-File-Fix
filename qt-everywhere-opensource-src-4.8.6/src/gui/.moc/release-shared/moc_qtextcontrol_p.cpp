...
static const char qt_meta_stringdata_QTextControl[] = {
    ...
    "updateRequest(QRectF)\0rect\0updateRequest()\0"
    "documentSizeChanged(QSizeF)\0"
    "blockCountChanged(int)\0newBlockCount\0"
    "visibilityRequest(QRectF)\0microFocusChanged()\0"
    "linkActivated(QString)\0link\0"
    "linkHovered(QString)\0modificationChanged(bool)\0"
    "m\0setPlainText(QString)\0text\0"
    "setHtml(QString)\0cut()\0copy()\0"
    "paste(QClipboard::Mode)\0mode\0paste()\0"
    "undo()\0redo()\0clear()\0selectAll()\0"
    "insertPlainText(QString)\0insertHtml(QString)\0"
    "append(QString)\0appendHtml(QString)\0"
    "html\0appendPlainText(QString)\0"
    "adjustSize()\0_q_updateCurrentCharFormatAndSelection()\0"
    ...
    "overwriteMode\0bool\0acceptRichText\0"
    "cursorWidth\0int\0textInteractionFlags\0"
    "Qt::TextInteractionFlags\0openExternalLinks\0"

...
static const char qt_meta_stringdata_QInputDialog[] = {
    "QInputDialog\0textValueChanged(QString)\0"
    "text\0\0textValueSelected(QString)\0"
    "intValueChanged(int)\0value\0"
    "intValueSelected(int)\0doubleValueChanged(double)\0"

...
static const char qt_meta_stringdata_QWizard[] = {
    "QWizard\0currentIdChanged(int)\0id\0\0"
    "helpRequested()\0customButtonClicked(int)\0"
    "which\0pageAdded(int)\0pageRemoved(int)\0"
    "back()\0next()\0restart()\0"
    "_q_emitCustomButtonClicked()\0"
    "_q_updateButtonStates()\0"
    "_q_handleFieldObjectDestroyed(QObject*)\0"
    "wizardStyle\0WizardStyle\0options\0"
    "WizardOptions\0titleFormat\0Qt::TextFormat\0"
    "subTitleFormat\0startId\0int\0currentId\0"

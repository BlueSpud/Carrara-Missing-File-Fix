...
static const char qt_meta_stringdata_QIdentityProxyModel[] = {
    "QIdentityProxyModel\0"
    "_q_sourceRowsAboutToBeInserted(QModelIndex,int,int)\0"
    ",,\0\0_q_sourceRowsInserted(QModelIndex,int,int)\0"
    ...
    ",,,,\0_q_sourceRowsMoved(QModelIndex,int,int,QModelIndex,int)\0"
    ...
    ",\0_q_sourceHeaderDataChanged(Qt::Orientation,int,int)\0"

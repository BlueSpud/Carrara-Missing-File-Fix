...
static const uint qt_meta_data_QTreeWidget[] = {
 ...
 // slots: signature, parameters, type, tag, flags
     ...
     934,   58,   58,   58, 0x08,
     944,  984,   58,   58, 0x08,
    1004, 1055,   58,   58, 0x08,

 // properties: name, type, flags
    1075, 1087, 0x02095103,
    1091, 1087, 0x02095001,

       0        // eod
};

static const char qt_meta_stringdata_QTreeWidget[] = {
    "QTreeWidget\0itemPressed(QTreeWidgetItem*,int)\0"
    "item,column\0\0itemClicked(QTreeWidgetItem*,int)\0"
    ...
    "itemExpanded(QTreeWidgetItem*)\0item\0"
    ...
    "item,hint\0scrollToItem(const QTreeWidgetItem*)\0"
    ...
    "selected,deselected\0columnCount\0int\0"
    "topLevelItemCount\0"
};

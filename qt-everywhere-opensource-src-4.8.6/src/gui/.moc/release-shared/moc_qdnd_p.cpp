...
void QCocoaDropData::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData QCocoaDropData::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QCocoaDropData::staticMetaObject = {
    { &QInternalMimeData::staticMetaObject, qt_meta_stringdata_QCocoaDropData,
      qt_meta_data_QCocoaDropData, &staticMetaObjectExtraData }
};

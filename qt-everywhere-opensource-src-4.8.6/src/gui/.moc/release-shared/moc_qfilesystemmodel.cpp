...
static const char qt_meta_stringdata_QFileSystemModel[] = {
    "QFileSystemModel\0rootPathChanged(QString)\0"
    "newPath\0\0fileRenamed(QString,QString,QString)\0"
    "path,oldName,newName\0directoryLoaded(QString)\0"
    "path\0_q_directoryChanged(QString,QStringList)\0"
    "directory,list\0_q_performDelayedSort()\0"
    "_q_fileSystemChanged(QString,QList<QPair<QString,QFileInfo> >)\0"
    "path,\0_q_resolvedName(QString,QString)\0"
    "fileName,resolvedName\0resolveSymlinks\0"
    "bool\0readOnly\0nameFilterDisables\0"
};

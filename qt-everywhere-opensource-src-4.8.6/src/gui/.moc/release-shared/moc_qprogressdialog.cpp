...
static const char qt_meta_stringdata_QProgressDialog[] = {
    "QProgressDialog\0canceled()\0\0cancel()\0"
    "reset()\0setMaximum(int)\0maximum\0"
    "setMinimum(int)\0minimum\0setRange(int,int)\0"
    "minimum,maximum\0setValue(int)\0progress\0"
    "setLabelText(QString)\0text\0"
    "setCancelButtonText(QString)\0"
    "setMinimumDuration(int)\0ms\0forceShow()\0"
    "_q_disconnectOnClose()\0wasCanceled\0"
    "bool\0int\0value\0autoReset\0autoClose\0"
    "minimumDuration\0labelText\0QString\0"
};

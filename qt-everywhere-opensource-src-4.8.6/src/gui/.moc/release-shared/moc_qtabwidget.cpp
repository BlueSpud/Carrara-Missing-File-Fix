...
static const char qt_meta_stringdata_QTabWidget[] = {
    "QTabWidget\0currentChanged(int)\0index\0"
    "\0tabCloseRequested(int)\0setCurrentIndex(int)\0"
    "setCurrentWidget(QWidget*)\0widget\0"
    "_q_showTab(int)\0_q_removeTab(int)\0"
    "_q_tabMoved(int,int)\0,\0tabPosition\0"
    "TabPosition\0tabShape\0TabShape\0"
    "currentIndex\0int\0count\0iconSize\0QSize\0"
    "elideMode\0Qt::TextElideMode\0"
    "usesScrollButtons\0bool\0documentMode\0"
